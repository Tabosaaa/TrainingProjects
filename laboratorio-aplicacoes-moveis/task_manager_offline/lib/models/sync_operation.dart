...
class SyncOperation {
  ...
  /// Converter para Map (usando JSON para serializar data corretamente)
  ...
  static Map<String, dynamic> _parseData(dynamic dataValue) {
    ...
    if (dataValue is Map<String, dynamic>) return dataValue;
    if (dataValue is String) {
      try {
        return json.decode(dataValue) as Map<String, dynamic>;
      } catch (e) {
        return {};
      }
    }
